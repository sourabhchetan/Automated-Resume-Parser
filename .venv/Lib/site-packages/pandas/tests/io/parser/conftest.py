...
def c_parser_only(request):
    """
    Fixture all of the CSV parser using the C engine.
    """
...
def python_parser_only(request):
    """
    Fixture all of the CSV parser using the Python engine.
    """
    return request.param()
...
def pyarrow_parser_only(request):
    """
    Fixture all of the CSV parser using the Pyarrow engine.
    """
    return request.param()
